...
int delta_t_cut_mac()
{
	...
	*/
	...
	/*//This is old  e16 data
	chain.AddFile("/Users/cmc/Desktop/phd/data/e16/ntp_30540_pass1.a13.root"); file_num++;
	...
	std::cout<<"There are " <<file_num <<" Files loaded" <<endl;
	...
	std::cout<<"Defining Root Variables: ";
	...
	std::cout<<"Defining Program Variables: ";
	...
	std::cout<<"Setting Branch Addresses: ";
	//Set Branch Address
	...
	std::cout<<"number of events: " <<events <<endl;

	std::cout<<"Plot Skeletons: ";
	//Create Plots
	...
	std::cout<<"Looping Through Events" <<endl;
	//Loop through events
	for(int i=0;i<events;i++)
	{
		chain.GetEntry(i);
		progress = (int) 100.0*(((double)i+1.0)/(double)events);
		//std::cout<<"Current Entry " <<i <<"\r";
		...
		std::cout<<"Progess Percent " <<progress <<"\r";
	}
	std::cout<<endl;
	std::cout<<"Loop Complete" <<endl;
